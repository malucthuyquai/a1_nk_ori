...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		// FRIEND
		db.execSQL("CREATE TABLE FRIEND ( USER_KEY TEXT NOT NULL, FRIEND_KEY TEXT NOT NULL, FRIEND_USERNAME TEXT, AVATAR_CACHE TEXT, RELATIONSHIP TEXT (2) DEFAULT '-1', BLOCKED TEXT, OSG_USER_KEY TEXT, OSG_KID_ID TEXT, PRIMARY KEY (USER_KEY ASC, FRIEND_KEY))");
		// CONVERSATION
